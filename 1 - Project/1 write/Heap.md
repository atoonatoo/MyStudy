...
- heap의 삽입 연산
	...
	- Heapify (힙의 재구조화)
		- 수행과정에서 생길수도 있는 구조의 변화로 인해 힙의 속성이 깨질 수 있기 때문에, 
        		  ![](https://velog.velcdn.com/images/atoonatoo/post/641f0a73-950c-461f-9efa-dba7fd3be17f/image.png)
삽입/삭제시 힙의 재구조화를 요구된다.
