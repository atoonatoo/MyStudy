...
| **액터명**     | 사용자                                                                                                                                                                                                                                                                     |
| **개요 및 설명** | 사용자는 영상을 시청하는 도중에도 메모를 이용하거나, GPT에게 질문을 하고 실시간으로 답변을 받을 수 있다. 이를 통해 영상 시청과 동시에 생각을 정리하거나, 궁금한 내용을 실시간으로 확인할 수 있다.                                                                                                                                                       |
...
| **요구사항명**   | 메모 수정                                                                                                                                                                                                                                                                                                                                                                  |
| **액터명**     | 사용자                                                                                                                                                                                                                                                                                                                                                                    |
| **개요 및 설명** | 사용자는 기존에 등록한 메모를 수정할 수 있으며, 수정된 메모는 업데이트된 내용으로 저장된다.                                                                                                                                                                                                                                                                                                                           |
